...
@property(nonatomic,copy)NSString *start_station_name;  // 始发站名
@property(nonatomic,copy)NSString *end_station_name;    // 终点站名
...
@property(nonatomic,copy)NSString *to_station_name;     // 出发站名
@property(nonatomic,copy)NSString *from_station_name;   // 目的站名
